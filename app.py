...
# --- RESPONSE MODEL ---
# মডেল আপডেট করা হয়েছে যাতে এরর হলে ডিফল্ট ভ্যালু রিটার্ন করে
...
def generate_account(
    ...
    # ফিক্স: রেন্ডম নাম্বার বাতিল করে সরাসরি ইউজার ইনপুট নাম ব্যবহার করা হয়েছে।
    ...
    try:
        ...
        # ফিক্স: একই নাম থাকলে বা একাউন্ট তৈরি না হলে রেসপন্সে পরিষ্কার এরর মেসেজ দেখাবে।
        if not jwt_token or account_id == "N/A": 
            return AccountResponse(
                status="error",
                message="এই নামটি ইতিমধ্যে অন্য কোনো অ্যাকাউন্টে ব্যবহার করা হয়েছে বা নামটিতে অবৈধ অক্ষর আছে। দয়া করে অন্য একটি নাম দিয়ে চেষ্টা করুন।"
            )
        ...
        return AccountResponse(
            status="success",
            message="Account generated successfully using exactly provided name.",
            is_active=True,
